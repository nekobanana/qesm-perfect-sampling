...
#scp script.sh giorgi@192.168.3.47:"${project_folder}"
scp -r files/input giorgi@192.168.3.47:"${project_folder}"/files
scp postprocess/*.py giorgi@192.168.3.47:"${project_folder}"/postprocess
